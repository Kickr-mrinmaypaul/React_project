  ...
  return (
    <nav className='justify-between flex flex-col top-0 right-0 sm:left-30 md:left-40  lg:left-50 xl:left-64 space-y-10 sm:w-auto md:w-auto lg:w-auto xl:w-auto 2xl:w-auto absolute'>
      <div className='flex justify-between items-center bg-[#1a656d] sm:px-4 md:px-4 lg:px-5 xl:px-7 2xl:px-9 sm:pt-3 md:pt-3 lg:pt-4 xl:pt-5 2xl:pt-7 sm:pb-15 md:pb-15 lg:pb-17 xl:pb-20 2xl:pb-23'>
        ...
        {currentPath === "/users" && (
         <div>
          <h1 className='sm:text-lg md:text-lg lg:text-2xl xl:text-3xl 2xl:4xl text-amber-50 pt-10'>Users Mangement</h1>
          <span className='text-sm text-[#FFFFFF] opacity-60'>Manage and moniter user accounts</span>
         </div>
        )}
        {currentPath === "/users/viewusers" && (
         <div>
          <h1 className='sm:text-lg md:text-lg lg:text-2xl xl:text-3xl 2xl:4xl text-amber-50 pt-10'>Users Mangement</h1>
          <span className='text-sm text-[#FFFFFF] opacity-60'>Manage and moniter user accounts</span>
         </div>
        ...
        {currentPath === "/admin" && (
         <div>
          <h1 className='sm:text-lg md:text-lg lg:text-2xl xl:text-3xl 2xl:4xl text-amber-50 pt-10'>Admin Settings</h1>
          <span className='text-sm text-[#FFFFFF] opacity-60'>Manage your profile, security settings.</span>
         </div>
        )}
        {currentPath == "/" && (
