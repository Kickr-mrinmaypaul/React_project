  ...
  return (
    <div className='bg-[#020028] flx-1 overflow-auto absolute h-screen w-auto sm:top-27 md:top-27 lg:top-31 xl:top-36 2xl:top-39 sm:left-30 md:left-40  lg:left-50 xl:left-64 right-0 border-2 border-l-[#1a656d]  sm:pl-8 sm:pr-5 sm:pt-4 md:pl-9 md:pr-6 md:pt-4 xl:pl-15 xl:pr-10 xl:pt-7 2xl:pl-18 2xl:pr-12 2xl:pt-8'>
        <div className='bg-[#000005] border-2 border-[#9B9476] rounded-2xl flex-1 overflow-auto sm:p-2 md:p-2 lg:p-2.5 xl:p-3 2xl:p-4'> 
            ...
            <div className='grid grid-cols-2 flex-1 overflow-auto mt-4'>
                <div className='border-2 border-[#9B9476] m-3 rounded-2xl p-3'>
                    ...
                    <div className='flex flex-col justify-center items-center'>
                        ...
                        alt="profile" 
                        className=' h-30 w-30 rounded-full justify-center items-center mb-2'
                        />
                ...
                <div className='border-2 border-[#9B9476] m-3 rounded-2xl p-3'>
                    ...
                    <div className='flex flex-row justify-between'>
                        <div>
                            <button className='text-xl text-amber-50'>Active</button>
                        </div>
                        <div>
